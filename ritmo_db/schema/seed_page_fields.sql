-- Seed della tabella s_page_fields.
-- Eseguito dopo la creazione dello schema.
-- DELETE + INSERT garantisce uno stato sempre deterministico e aggiornabile.

DELETE FROM s_page_fields;

INSERT OR IGNORE INTO s_page_fields (page, field_key, data_kind, sort_order, enum_values, relation_type, target_table, target_field) VALUES
    -- book_page
    ...
    ('book_page', 'field-publisher',        'string', 40, NULL, 'fk',       'd_publishers',          'publisher_id'),
